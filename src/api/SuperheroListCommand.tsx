...
export class SuperheroListCommand implements SuperheroCommand {
  readonly url: string = `${process.env.REACT_APP_API_SERVER}/api/v1/superheroes?page=${--this.page}`;

  constructor(private receiver: SuperheroReceiver, private token: string, private page: number) {}
